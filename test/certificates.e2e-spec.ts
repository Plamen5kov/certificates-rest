...
import { AuthModule } from '../src/logic/auth/auth.module';
import { TypeOrmModule } from '@nestjs/typeorm';
import { options } from '../data-source-test.config';
import { CertificatesModule } from '../src/logic/certificates/certificates.module';
import { login } from './helpers';
import { randomUUID } from 'crypto';
import {
  Certificate,
  Status,
} from '../src/logic/certificates/entities/certificate.entity';
